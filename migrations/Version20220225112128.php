 ...
 */
final class Version20220225112128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, pseudo_id INT NOT NULL, artiste_id INT NOT NULL, INDEX IDX_9474526C20E394C2 (pseudo_id), INDEX IDX_9474526C21D25844 (artiste_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526C20E394C2 FOREIGN KEY (pseudo_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526C21D25844 FOREIGN KEY (artiste_id) REFERENCES artiste (id)');
    }
